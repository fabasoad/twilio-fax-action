...
core.warning(
  ...
  'where possibility to send faxes has been removed. More information: ' +
  'https://github.com/twilio/twilio-node/releases/tag/3.74.0 and ' +
  'https://www.twilio.com/changelog/programmable-fax-end-life-one-year-notice'
)
